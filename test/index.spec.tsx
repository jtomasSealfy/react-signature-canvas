...
function rSCInstance (wrapper: RenderResult): SignatureCanvas {
  const instance = findInstance(wrapper.container)
  console.log(instance)
  return instance as SignatureCanvas
}

test('mounts canvas and instance properly', () => {
  const wrapper = render(<SignatureCanvas />)
  // expect(container.exists('canvas')).toBe(true)
...
describe('SigCanvas wrapper methods return equivalent to SigPad', () => {
  const rSigPad = rSCInstance(render(<SignatureCanvas />))
...
describe('get methods', () => {
  const instance = rSCInstance(render(
...
describe('canvas resizing', () => {
  ...
  it.skip('should not clear when clearOnResize is false', () => {
  ...
  it.skip('should not change size if fixed width & height', () => {
  ...
  it.skip('should change size if no width or height', () => {
  ...
  it.skip('should partially change size if one of width or height', () => {
